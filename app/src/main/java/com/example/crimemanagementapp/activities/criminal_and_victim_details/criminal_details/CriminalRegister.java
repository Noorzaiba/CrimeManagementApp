...
public class CriminalRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProfileTV.setText("Criminal Registration");
        ...
        if(test==true){
            ...
            call.enqueue(new Callback<VictimCriminalDefaultResponse> (){
                    ...
                    try{
                        ...
                        if(response.code()==200){
                            ...
                            if(res.isFlag()){
                                ...
                                Toast.makeText(CriminalRegister.this,"Register unsuccessful",Toast.LENGTH_LONG).show();
                            }



                        }else{
                            Toast.makeText(CriminalRegister.this,"Authentication Error",Toast.LENGTH_LONG).show();
                        }

                    }catch (Exception e){
                        Toast.makeText(CriminalRegister.this,e.getMessage(),Toast.LENGTH_LONG).show();
                    }
                ...
                public void onFailure(Call<VictimCriminalDefaultResponse> call, Throwable t) {
                    Toast.makeText(CriminalRegister.this,t.getMessage(),Toast.LENGTH_LONG).show();
                }
            });
        }
