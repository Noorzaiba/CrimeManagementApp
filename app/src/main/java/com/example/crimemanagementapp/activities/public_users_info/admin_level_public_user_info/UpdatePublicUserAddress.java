...
public class UpdatePublicUserAddress extends AppCompatActivity {
    private EditText addressET,cityET,stateET,pincodeET,latitudeET,longitudeET,idET;
    private Button submitButton ;
    Intent intent;
    String fileName,loggedInEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public_user_address_put);
        ...
        if(test==true){
           ...
           publicUserAddressId=Integer.parseInt(idET.getText().toString());
            ...
            Call<AddressObjectDefaultResponse> call = RetrofitClient
                    .getInstance()
                    .getApi()
                    .putDetailPublicUserAddress(loggedInEmail,resident_id,address);
