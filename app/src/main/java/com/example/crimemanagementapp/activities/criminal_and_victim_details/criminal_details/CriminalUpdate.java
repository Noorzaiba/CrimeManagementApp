...
import com.example.crimemanagementapp.activities.criminal_and_victim_details.victim_details.VictimToCriminalActivity;
...
public class CriminalUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateProfileTV.setText("Update Criminal Profile");
        ...
        this.victimToCriminalAndCriminalToVictimButton.setText("Click to Transfer to Victim Record");

        this.deleteRecord = findViewById(R.id.deleteRecord);
        this.deleteRecord.setText("Delete Criminal Record");
       ...
       deleteRecord.setOnClickListener(new View.OnClickListener() {
        ...
        victimToCriminalAndCriminalToVictimButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addressET.getText().toString().equals("AddressDoesNotExists")){
                    ...
                    Intent intent=new Intent(getApplicationContext(), CriminalToVictimActivity.class);
        ...
        addressWithoutMapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             Log.i("criminal_id",String.valueOf(criminal_id));
                if (addressET.getText().toString().equals("AddressDoesNotExists")){

                    Intent intent=new Intent(getApplicationContext(), CriminalAddressRegister.class);
                    intent.putExtra("resident_id",criminal_id);
                    intent.putExtra("fileName","CriminalAddressRegister");
                    startActivity(intent);}else{

                    Intent intent=new Intent(getApplicationContext(), CriminalAddressUpdate.class);
                intent.putExtra("resident_id",criminal_id);
                intent.putExtra("fileName","CriminalAddressUpdate");
                startActivity(intent);
            }}
        });
...
void deleteCriminalRecord(){
    ...
    Call<DeleteObject> call= RetrofitClient
            .getInstance()
            .getApi()
            .criminalDeleteFacility(loggedInEmail,loggedInToken,Integer.valueOf(idET.getText().toString()));
    ...
    void deleteCriminalAddressRecord(){

        Call<DeleteObject> call= RetrofitClient
                .getInstance()
                .getApi()
                .deleteCriminalAddress(loggedInEmail,loggedInToken,Integer.valueOf(idET.getText().toString()));
        ...
        if(test==true){
           ...
           victimCriminalRegisterModel=new VictimCriminalRegisterModel(Integer.parseInt(idR),firstNameR,lastNameR,emailIdR,Integer.parseInt(ageR),Long.parseLong(phoneNumberR),remarksR,genderR,Long.parseLong(salaryR),occupationR,Integer.parseInt(crimeIdR),docR,douR,Long.parseLong(adhaarNoR),imageNameTV.getText().toString());
            ...
            Call<VictimCriminalDefaultResponse> call= RetrofitClient
                    ...
                    .getInstance()
                    .getApi()
                    .criminalPutDetailFacility(loggedInEmail,loggedInToken,Integer.parseInt(idR),victimCriminalRegisterModel);
            ...
            call.enqueue(new Callback<VictimCriminalDefaultResponse>() {
                ...
                public void onResponse(Call<VictimCriminalDefaultResponse> call, Response<VictimCriminalDefaultResponse> response) {
                    ...
                    try{
                            ...
                            if(res.isFlag()){
                               ...
                               VictimCriminalRegisterModel obj=res.getVictimCriminalRegisterModelList().get(0);
                                ...
                                if("Invalid_Crime_id".equals(obj.getEmail())){
                                    ...
                                    Toast.makeText(CriminalUpdate.this,"Updated Successfully",Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(CriminalUpdate.this,e.getMessage(),Toast.LENGTH_LONG).show();
                    }
                ...
                public void onFailure(Call<VictimCriminalDefaultResponse> call, Throwable t) {
                    Toast.makeText(CriminalUpdate.this,t.getMessage(),Toast.LENGTH_LONG).show();
                }
            });
            }else{
            Toast.makeText(CriminalUpdate.this,"Validation Pending",Toast.LENGTH_LONG).show();
        }
    ...
    void getCriminalDetails() {
        ...
        Call<VictimCriminalDefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .criminalGETDetailFacility(loggedInEmail,loggedInToken,pk);
                    ...
                    if(response.code()==200){
                        ...
                        if(res.isFlag()){
                          ...
                          //  Toast.makeText(CriminalUpdate.this,String.valueOf(victimCriminalRegisterModelList.get(0).getId()),Toast.LENGTH_LONG).show();
                            ...
                            getCriminalAddress(criminal_id);
    ...
    void getCriminalAddress(int resident_id){
        Call<AddressObjectDefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .getDetailCriminalAddress(loggedInEmail,loggedInToken,resident_id);
