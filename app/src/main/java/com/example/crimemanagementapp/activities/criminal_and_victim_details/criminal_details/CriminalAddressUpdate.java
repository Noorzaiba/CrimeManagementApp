...
public class CriminalAddressUpdate extends AppCompatActivity {
    private EditText addressET,cityET,stateET,pincodeET,latitudeET,longitudeET,idET;
    private Button submitButton ;
    Intent intent;
    String fileName;
    int resident_id,address_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCriminalAddress(resident_id);
    ...
    void updateCriminalAddress(){
        ...
        if(test==true){
            ...
            address_id=Integer.parseInt(idET.getText().toString());
            Log.i("id",String.valueOf(id));
            AddressObject address =new AddressObject(address_id,addressR,cityR,stateR,longitude,latitude,pincode,resident_id);
            Call<AddressObjectDefaultResponse> call = RetrofitClient
                    .getInstance()
                    .getApi()
                    .putDetailCriminalAddress(loggedInEmail,loggedInToken,resident_id,address);
