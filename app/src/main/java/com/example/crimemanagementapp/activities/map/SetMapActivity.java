...
public class SetMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void getAddress(double myLat, double myLong) throws IOException {
        ...
        try{
            ...
            pincode=Long.parseLong(addresses.get(0).getPostalCode());
            Log.i("country",fullAddress);
            Log.i("country",cityName);
            Log.i("country", stateName );
            Log.i("country",countryName1);
            Log.i("country",String.valueOf(latitude));
            Log.i("country",String.valueOf(longitude));
            Log.i("country",String.valueOf(pincode));
            transferData();
        }catch(NullPointerException e){
            Toast.makeText(getApplicationContext(),"Enter the Address properly with locality, city, pincode and state",Toast.LENGTH_LONG).show(); }
        catch (Exception e){
    ...
    private void geoLocate(){
        ...
        try{
            ...
            Toast.makeText(getApplicationContext(), "Google maps not working",Toast.LENGTH_LONG).show();
        }
        Log.e("TAG","geoLocate: before list ");
        if(list.size()>0){
            Address address=list.get(0);
    ...
    void transferData(){
        ...
        int  resident_id=intent.getIntExtra("resident_id",0);
        Log.i("resident_id",String.valueOf(resident_id));
        Log.i("id in set",fileName);
        AddressObject addressObject=new AddressObject(fullAddress,cityName,stateName,longitude,latitude,pincode,resident_id);
        Intent i=new Intent(getApplicationContext(),AddressTransferActivity.class);
