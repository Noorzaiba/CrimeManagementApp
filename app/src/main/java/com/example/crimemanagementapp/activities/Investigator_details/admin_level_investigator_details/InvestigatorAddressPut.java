...
public class InvestigatorAddressPut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_investigator_address_put);
        ...
        operationTV.setText("Update Address Details");
        ...
        Log.i(" profile address",String.valueOf(resident_id));
        getInvestigatorAddress(resident_id);
    ...
    void updateInvestigatorAddress(){
        ...
        if(test==true){
            ...
            AddressObject address =new AddressObject(id,addressR,cityR,stateR,longitude,latitude,pincode,resident_id);


            Call<AddressObjectDefaultResponse> call = RetrofitClient
                    .getInstance()
                    .getApi()
                    . putDetailInvestigatorAddress(loggedInEmail,loggedInToken,resident_id,address);
                             ...
                             public void onResponse(Call<AddressObjectDefaultResponse> call, Response<AddressObjectDefaultResponse> response) {
                                 try{
                                     if(200==response.code()) {
                                         ...
                                         idET.setText(String.valueOf(addressObjectLoaded.getId()));
