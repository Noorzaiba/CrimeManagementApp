package com.example.crimemanagementapp.activities.queries_info.queries_by_investigators;
...
public class QueryDetailInvestigator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_query_detail_investigator);
    ...
    void getQueryDetails() {
        ...
        Call<InvestigatorContactUsDefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .getAllDetailQueryFacilityOfInvestigator(loggedInEmail,loggedInToken,pk);
    ...
    void deleteQueryRecord(){
        Call<DeleteObject> call= RetrofitClient
                .getInstance()
                .getApi()
                .deleteQueryFacilityOfInvestigator(loggedInEmail,loggedInToken,Integer.valueOf(idET.getText().toString()));
